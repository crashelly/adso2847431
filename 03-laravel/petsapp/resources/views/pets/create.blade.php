...
<div class="breadcrumbs text-sm text-white">
  <ul>
    <li><a><a href="{{ url('Pets') }}">Pet Module</a></a></li>
    <li><a>Create Pet</a></li>
    
  </ul>
</div>
  <form method="post" action="{{ url('Pets.store') }}" class="pt-4 pb-20" enctype="multipart/form-data">
        @csrf
        <fieldset class="fieldset w-md bg-base-200 border border-base-300 p-4 rounded-box">
                ...
                @endif
                 <div class="avatar flex flex-col gap-2 items-center  mx-auto">
                    <div id="upload" class="mask mask-squircle w-36 cursor-pointer hover:scale-110 hover:border-gray-500 border   transition-transform">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5m-13.5-9L12 3m0 0 4.5 4.5M12 3v13.5" />
                ...
                <button class="btn mt-4 p-6 rounded-full text-white bg-cyan-800  hover:bg-cyan-800 w-full">create</button>
